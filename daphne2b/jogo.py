...
# Configurando o som.
somFinal = pygame.mixer.Sound('laser (1).wav')
somRecorde = pygame.mixer.Sound('record (1).wav')
somTiro = pygame.mixer.Sound('laser (1).wav')
pygame.mixer.music.load('trilha_nave (1).wav')
...
while True:
    ...
    while deve_continuar:
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                ...
                if evento.key == pygame.K_SPACE:
                    raio = {
                        'objRect': pygame.Rect(
                            jogador['objRect'].centerx, jogador['objRect'].top, LARGURARAIO, ALTURARAIO
                        ),
                        'imagem': imagemRaio,
                        'vel': VELRAIO,
                    }
        ...
        if contador >= ITERACOES:
            ...
            asteroide = {
                'objRect': pygame.Rect(posX, posY, tamAsteroide, tamAsteroide),
